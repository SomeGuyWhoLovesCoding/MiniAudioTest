...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("MiniAudioTest", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		#if !munit
		var app = new Main();
		app.meta.set("build", "27");
		app.meta.set("company", "MiniAudioTest");
		app.meta.set("file", "MiniAudioTest");
		app.meta.set("name", "MiniAudioTest");
		app.meta.set("packageName", "com.sample.miniaudiotest");
		...
		#elseif air
		app.window.title = "MiniAudioTest";
		#else
