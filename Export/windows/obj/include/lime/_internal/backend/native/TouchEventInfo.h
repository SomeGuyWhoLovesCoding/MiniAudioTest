...
HX_DECLARE_STACK_FRAME(_hx_pos_dc6fd8f0bbdab31a_919_new)
...
HXLINE( 920)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 921)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->x = x;
HXLINE( 922)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->y = y;
HXLINE( 923)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->id = id;
HXLINE( 924)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->dx = dx;
HXLINE( 925)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->dy = dy;
HXLINE( 926)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->pressure = pressure;
HXLINE( 927)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->device = device;
            	}
