...
HX_DECLARE_STACK_FRAME(_hx_pos_a21879e7650910f2_679_new)
...
HXLINE( 680)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 681)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->file = file;
            	}
