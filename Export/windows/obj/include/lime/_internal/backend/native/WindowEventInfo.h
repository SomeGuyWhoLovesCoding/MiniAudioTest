...
HX_DECLARE_STACK_FRAME(_hx_pos_d8a53269ce4a50a3_953_new)
...
HXLINE( 954)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 955)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->windowID = windowID;
HXLINE( 956)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->width = width;
HXLINE( 957)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->height = height;
HXLINE( 958)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->x = x;
HXLINE( 959)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->y = y;
            	}
