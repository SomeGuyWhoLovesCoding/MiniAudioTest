...
HX_DECLARE_STACK_FRAME(_hx_pos_60e5fd49cce3a06e_858_new)
...
HXLINE( 859)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 860)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->id = id;
HXLINE( 861)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->x = x;
HXLINE( 862)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->y = y;
HXLINE( 863)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->z = z;
            	}
