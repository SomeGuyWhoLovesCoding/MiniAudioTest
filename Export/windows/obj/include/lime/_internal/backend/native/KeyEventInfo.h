...
HX_DECLARE_STACK_FRAME(_hx_pos_cef4a471e9b9c478_771_new)
...
HXLINE( 772)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 773)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->windowID = windowID;
HXLINE( 774)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->keyCode = keyCode;
HXLINE( 775)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->modifier = modifier;
            	}
