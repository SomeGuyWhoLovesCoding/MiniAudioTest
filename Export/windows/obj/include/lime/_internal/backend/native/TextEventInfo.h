...
HX_DECLARE_STACK_FRAME(_hx_pos_48b909785036aaec_887_new)
...
HXLINE( 888)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 889)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->windowID = windowID;
HXLINE( 890)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->text = text;
HXLINE( 891)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->start = start;
HXLINE( 892)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->length = length;
            	}
