...
HX_DECLARE_STACK_FRAME(_hx_pos_21cd05885e6e0032_737_new)
...
HXLINE( 738)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 739)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->id = id;
HXLINE( 740)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->index = index;
HXLINE( 741)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->eventValue = value;
HXLINE( 742)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->x = x;
HXLINE( 743)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->y = y;
            	}
