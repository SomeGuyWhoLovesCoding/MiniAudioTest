...
HX_DECLARE_STACK_FRAME(_hx_pos_d0c0bd38b1c3a1bc_704_new)
...
HXLINE( 705)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 706)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->id = id;
HXLINE( 707)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->button = button;
HXLINE( 708)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->axis = axis;
HXLINE( 709)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->axisValue = value;
            	}
