...
class HXCPP_CLASS_ATTRIBUTES Window_obj : public ::hx::Object
{
	...
	public:
		...
		int id;
		 ...
		 ::lime::app::_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Float_Void onKeyDownPrecise;
		 ::lime::app::_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void onKeyUp;
		 ::lime::app::_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Float_Void onKeyUpPrecise;
