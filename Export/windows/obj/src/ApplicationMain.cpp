...
HXLINE(  12)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("MiniAudioTest",91,66,09,3f),::ApplicationMain_obj::create_dyn());
...
HXLINE(  27)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("27",c5,2b,00,00));
HXLINE(  28)		app->meta->set(HX_("company",3d,15,69,83),HX_("MiniAudioTest",91,66,09,3f));
HXLINE(  29)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("MiniAudioTest",91,66,09,3f));
HXLINE(  30)		app->meta->set(HX_("name",4b,72,ff,48),HX_("MiniAudioTest",91,66,09,3f));
HXLINE(  31)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.sample.miniaudiotest",ba,68,3e,71));
...
HXLINE(  36)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("MiniAudioTest",91,66,09,3f))
