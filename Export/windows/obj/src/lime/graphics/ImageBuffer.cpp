...
HX_LOCAL_STACK_FRAME(_hx_pos_890299056ccc780d_192_get_src,"lime.graphics.ImageBuffer","get_src",0x9748e67e,"lime.graphics.ImageBuffer.get_src","lime/graphics/ImageBuffer.hx",192,0x6475c2cd)
HX_LOCAL_STACK_FRAME(_hx_pos_890299056ccc780d_197_set_src,"lime.graphics.ImageBuffer","set_src",0x8a4a778a,"lime.graphics.ImageBuffer.set_src","lime/graphics/ImageBuffer.hx",197,0x6475c2cd)
HX_LOCAL_STACK_FRAME(_hx_pos_890299056ccc780d_219_get_stride,"lime.graphics.ImageBuffer","get_stride",0xb11b1cbf,"lime.graphics.ImageBuffer.get_stride","lime/graphics/ImageBuffer.hx",219,0x6475c2cd)
namespace lime{
namespace graphics{
...
HXLINE( 168)		if (::hx::IsNotNull( this->data )) {
HXLINE( 170)			 ::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::alloc(this->data->byteLength);
HXLINE( 171)			bytes->blit(0,buffer->data->buffer,0,this->data->byteLength);
...
HXLINE( 172)				this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,4);
            			}
            			else {
HXLINE( 172)				if (::hx::IsNotNull( array )) {
HXLINE( 172)					 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXLINE( 172)						 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXLINE( 172)						if (::hx::IsNotNull( bytes )) {
HXLINE( 172)							 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 172)							int in_byteOffset = 0;
...
HXDLIN( 172)							int bufferByteLength = bytes->length;
...
HXDLIN( 172)							_this2->buffer = bytes;
...
HXLINE( 172)							HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            						}
            					}
            				}
            			}
HXDLIN( 172)			buffer->data = this1;
            		}
HXLINE( 176)		buffer->bitsPerPixel = this->bitsPerPixel;
HXLINE( 177)		buffer->format = this->format;
HXLINE( 178)		buffer->premultiplied = this->premultiplied;
HXLINE( 179)		buffer->transparent = this->transparent;
HXLINE( 180)		return buffer;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ImageBuffer_obj,clone,return )
 ...
 ::Dynamic ImageBuffer_obj::get_src(){
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_192_get_src)
HXDLIN( 192)		return this->_hx___srcCustom;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ImageBuffer_obj,get_src,return )
 ...
 ::Dynamic ImageBuffer_obj::set_src( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_197_set_src)
HXLINE( 211)		this->_hx___srcCustom = value;
...
int ImageBuffer_obj::get_stride(){
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_219_get_stride)
HXDLIN( 219)		int _hx_tmp = this->width;
HXDLIN( 219)		return (_hx_tmp * ::Std_obj::_hx_int((( (Float)(this->bitsPerPixel) ) / ( (Float)(8) ))));
            	}
