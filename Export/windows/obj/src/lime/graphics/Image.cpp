...
HXDLIN(1481)					int elementSize = _this1->bytesPerElement;
HXDLIN(1481)					if ((view->type == _this1->type)) {
HXLINE(1481)						int srcLength1 = srcData->length;
HXDLIN(1481)						int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(1481)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1481)						_this1->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            					}
            					else {
HXLINE(1481)						HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            					}
HXDLIN(1481)					_this1->byteLength = (_this1->bytesPerElement * srcLength);
HXDLIN(1481)					_this1->byteOffset = 0;
HXDLIN(1481)					_this1->length = srcLength;
...
HXDLIN(1481)						if ((::hx::Mod(in_byteOffset,_this2->bytesPerElement) != 0)) {
HXLINE(1481)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN(1481)						int bufferByteLength = buffer->length;
HXDLIN(1481)						int elementSize1 = _this2->bytesPerElement;
...
HXDLIN(1481)							if ((::hx::Mod(bufferByteLength,_this2->bytesPerElement) != 0)) {
HXLINE(1481)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
...
HXLINE(1481)							newByteLength = (( (int)(len) ) * _this2->bytesPerElement);
HXDLIN(1481)							int newRange = (in_byteOffset + newByteLength);
HXDLIN(1481)							if ((newRange > bufferByteLength)) {
HXLINE(1481)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
            						}
HXDLIN(1481)						_this2->buffer = buffer;
HXDLIN(1481)						_this2->byteOffset = in_byteOffset;
HXDLIN(1481)						_this2->byteLength = newByteLength;
HXDLIN(1481)						_this2->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this2->bytesPerElement) )));
...
HXDLIN(1559)						int elementSize = _this1->bytesPerElement;
HXDLIN(1559)						if ((view->type == _this1->type)) {
HXLINE(1559)							int srcLength1 = srcData->length;
HXDLIN(1559)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(1559)							_this1->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1559)							_this1->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE(1559)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN(1559)						_this1->byteLength = (_this1->bytesPerElement * srcLength);
HXDLIN(1559)						_this1->byteOffset = 0;
HXDLIN(1559)						_this1->length = srcLength;
...
HXDLIN(1559)							if ((::hx::Mod(in_byteOffset,_this2->bytesPerElement) != 0)) {
HXLINE(1559)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN(1559)							int bufferByteLength = buffer2->length;
HXDLIN(1559)							int elementSize1 = _this2->bytesPerElement;
...
HXDLIN(1559)								if ((::hx::Mod(bufferByteLength,_this2->bytesPerElement) != 0)) {
HXLINE(1559)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE(1559)								newByteLength = (( (int)(len) ) * _this2->bytesPerElement);
HXDLIN(1559)								int newRange = (in_byteOffset + newByteLength);
HXDLIN(1559)								if ((newRange > bufferByteLength)) {
HXLINE(1559)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN(1559)							_this2->buffer = buffer2;
HXDLIN(1559)							_this2->byteOffset = in_byteOffset;
HXDLIN(1559)							_this2->byteLength = newByteLength;
HXDLIN(1559)							_this2->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this2->bytesPerElement) )));
