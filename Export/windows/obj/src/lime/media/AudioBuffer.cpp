...
HX_DEFINE_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_68_new,"lime.media.AudioBuffer","new",0x18eea6a5,"lime.media.AudioBuffer.new","lime/media/AudioBuffer.hx",68,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_77_dispose,"lime.media.AudioBuffer","dispose",0xa3b05d64,"lime.media.AudioBuffer.dispose","lime/media/AudioBuffer.hx",77,0xf6fabaad)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_82_fromBase64,"lime.media.AudioBuffer","fromBase64",0xbd10aef4,"lime.media.AudioBuffer.fromBase64","lime/media/AudioBuffer.hx",82,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_128_fromBytes,"lime.media.AudioBuffer","fromBytes",0x20c94aa6,"lime.media.AudioBuffer.fromBytes","lime/media/AudioBuffer.hx",128,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_161_fromFile,"lime.media.AudioBuffer","fromFile",0x1084eca1,"lime.media.AudioBuffer.fromFile","lime/media/AudioBuffer.hx",161,0xf6fabaad)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_238_fromVorbisFile,"lime.media.AudioBuffer","fromVorbisFile",0x6dde6b54,"lime.media.AudioBuffer.fromVorbisFile","lime/media/AudioBuffer.hx",238,0xf6fabaad)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_259_loadFromFile,"lime.media.AudioBuffer","loadFromFile",0x735d4267,"lime.media.AudioBuffer.loadFromFile","lime/media/AudioBuffer.hx",259,0xf6fabaad)
...
void AudioBuffer_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_68_new)
            	}
...
void AudioBuffer_obj::dispose(){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_77_dispose)
HXDLIN(  77)		::lime::media::openal::AL_obj::deleteBuffer(this->_hx___srcBuffer);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,set_src,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromBase64(::String base64String){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_82_fromBase64)
HXLINE(  83)		if (::hx::IsNull( base64String )) {
HXLINE(  83)			return null();
            		}
HXLINE(  98)		::Array< ::String > base64StringSplit = base64String.split(HX_(",",2c,00,00,00));
HXLINE(  99)		::String base64StringNoEncoding = base64StringSplit->__get((base64StringSplit->length - 1));
HXLINE( 100)		 ::haxe::io::Bytes bytes = ::lime::_internal::format::Base64_obj::decode(base64StringNoEncoding);
HXLINE( 101)		 ::lime::media::AudioBuffer audioBuffer =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 102)		 ::Dynamic elements = null();
HXDLIN( 102)		 ::haxe::io::Bytes buffer = ::haxe::io::Bytes_obj::alloc(0);
HXDLIN( 102)		::cpp::VirtualArray array = null();
HXDLIN( 102)		 ::lime::utils::ArrayBufferView view = null();
HXDLIN( 102)		 ::Dynamic len = null();
HXDLIN( 102)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 102)		if (::hx::IsNotNull( elements )) {
HXLINE( 102)			this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,4);
            		}
            		else {
HXLINE( 102)			if (::hx::IsNotNull( array )) {
HXLINE( 102)				 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 102)				_this->byteOffset = 0;
HXDLIN( 102)				_this->length = array->get_length();
HXDLIN( 102)				_this->byteLength = (_this->length * _this->bytesPerElement);
HXDLIN( 102)				_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 102)				_this->copyFromArray(array,null());
HXDLIN( 102)				this1 = _this;
            			}
            			else {
HXLINE( 102)				if (::hx::IsNotNull( view )) {
HXLINE( 102)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 102)					 ::haxe::io::Bytes srcData = view->buffer;
HXDLIN( 102)					int srcLength = view->length;
HXDLIN( 102)					int srcByteOffset = view->byteOffset;
HXDLIN( 102)					int srcElementSize = view->bytesPerElement;
HXDLIN( 102)					int elementSize = _this1->bytesPerElement;
HXDLIN( 102)					if ((view->type == _this1->type)) {
HXLINE( 102)						int srcLength1 = srcData->length;
HXDLIN( 102)						int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 102)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 102)						_this1->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            					}
            					else {
HXLINE( 102)						HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            					}
HXDLIN( 102)					_this1->byteLength = (_this1->bytesPerElement * srcLength);
HXDLIN( 102)					_this1->byteOffset = 0;
HXDLIN( 102)					_this1->length = srcLength;
HXDLIN( 102)					this1 = _this1;
            				}
            				else {
HXLINE( 102)					if (::hx::IsNotNull( buffer )) {
HXLINE( 102)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 102)						int in_byteOffset = 0;
HXDLIN( 102)						if ((in_byteOffset < 0)) {
HXLINE( 102)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN( 102)						if ((::hx::Mod(in_byteOffset,_this2->bytesPerElement) != 0)) {
HXLINE( 102)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN( 102)						int bufferByteLength = buffer->length;
HXDLIN( 102)						int elementSize1 = _this2->bytesPerElement;
...
HXDLIN( 102)							if ((::hx::Mod(bufferByteLength,_this2->bytesPerElement) != 0)) {
HXLINE( 102)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 102)							if ((newByteLength < 0)) {
HXLINE( 102)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
            						}
            						else {
HXLINE( 102)							newByteLength = (( (int)(len) ) * _this2->bytesPerElement);
HXDLIN( 102)							int newRange = (in_byteOffset + newByteLength);
HXDLIN( 102)							if ((newRange > bufferByteLength)) {
HXLINE( 102)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
            						}
HXDLIN( 102)						_this2->buffer = buffer;
HXDLIN( 102)						_this2->byteOffset = in_byteOffset;
HXDLIN( 102)						_this2->byteLength = newByteLength;
HXDLIN( 102)						_this2->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this2->bytesPerElement) )));
HXDLIN( 102)						this1 = _this2;
            					}
            					else {
...
HXLINE( 104)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_audio_load_bytes(::hx::DynamicPtr(bytes),::hx::DynamicPtr(audioBuffer))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,fromBase64,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_128_fromBytes)
HXLINE( 129)		if (::hx::IsNull( bytes )) {
HXLINE( 129)			return null();
            		}
HXLINE( 138)		 ::lime::media::AudioBuffer audioBuffer =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 139)		 ::Dynamic elements = null();
HXDLIN( 139)		 ::haxe::io::Bytes buffer = ::haxe::io::Bytes_obj::alloc(0);
...
HXLINE( 139)			this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,4);
            		}
            		else {
HXLINE( 139)			if (::hx::IsNotNull( array )) {
HXLINE( 139)				 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXLINE( 139)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXLINE( 139)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 139)						int in_byteOffset = 0;
...
HXDLIN( 139)		audioBuffer->data = this1;
HXLINE( 141)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_audio_load_bytes(::hx::DynamicPtr(bytes),::hx::DynamicPtr(audioBuffer))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,fromBytes,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromFile(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_161_fromFile)
HXLINE( 162)		if (::hx::IsNull( path )) {
HXLINE( 162)			return null();
            		}
HXLINE( 187)		 ::lime::media::AudioBuffer audioBuffer =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 188)		 ::Dynamic elements = null();
HXDLIN( 188)		 ::haxe::io::Bytes buffer = ::haxe::io::Bytes_obj::alloc(0);
HXDLIN( 188)		::cpp::VirtualArray array = null();
HXDLIN( 188)		 ::lime::utils::ArrayBufferView view = null();
HXDLIN( 188)		 ::Dynamic len = null();
HXDLIN( 188)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 188)		if (::hx::IsNotNull( elements )) {
HXLINE( 188)			this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,4);
            		}
            		else {
HXLINE( 188)			if (::hx::IsNotNull( array )) {
HXLINE( 188)				 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 188)				_this->byteOffset = 0;
HXDLIN( 188)				_this->length = array->get_length();
HXDLIN( 188)				_this->byteLength = (_this->length * _this->bytesPerElement);
HXDLIN( 188)				_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 188)				_this->copyFromArray(array,null());
HXDLIN( 188)				this1 = _this;
            			}
            			else {
HXLINE( 188)				if (::hx::IsNotNull( view )) {
HXLINE( 188)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 188)					 ::haxe::io::Bytes srcData = view->buffer;
HXDLIN( 188)					int srcLength = view->length;
HXDLIN( 188)					int srcByteOffset = view->byteOffset;
HXDLIN( 188)					int srcElementSize = view->bytesPerElement;
HXDLIN( 188)					int elementSize = _this1->bytesPerElement;
HXDLIN( 188)					if ((view->type == _this1->type)) {
HXLINE( 188)						int srcLength1 = srcData->length;
HXDLIN( 188)						int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 188)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 188)						_this1->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            					}
            					else {
HXLINE( 188)						HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            					}
HXDLIN( 188)					_this1->byteLength = (_this1->bytesPerElement * srcLength);
HXDLIN( 188)					_this1->byteOffset = 0;
HXDLIN( 188)					_this1->length = srcLength;
HXDLIN( 188)					this1 = _this1;
            				}
            				else {
HXLINE( 188)					if (::hx::IsNotNull( buffer )) {
HXLINE( 188)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 188)						int in_byteOffset = 0;
HXDLIN( 188)						if ((in_byteOffset < 0)) {
HXLINE( 188)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN( 188)						if ((::hx::Mod(in_byteOffset,_this2->bytesPerElement) != 0)) {
HXLINE( 188)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN( 188)						int bufferByteLength = buffer->length;
HXDLIN( 188)						int elementSize1 = _this2->bytesPerElement;
HXDLIN( 188)						int newByteLength = bufferByteLength;
HXDLIN( 188)						if (::hx::IsNull( len )) {
HXLINE( 188)							newByteLength = (bufferByteLength - in_byteOffset);
HXDLIN( 188)							if ((::hx::Mod(bufferByteLength,_this2->bytesPerElement) != 0)) {
HXLINE( 188)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 188)							if ((newByteLength < 0)) {
HXLINE( 188)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
            						}
            						else {
HXLINE( 188)							newByteLength = (( (int)(len) ) * _this2->bytesPerElement);
HXDLIN( 188)							int newRange = (in_byteOffset + newByteLength);
HXDLIN( 188)							if ((newRange > bufferByteLength)) {
HXLINE( 188)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
            						}
HXDLIN( 188)						_this2->buffer = buffer;
HXDLIN( 188)						_this2->byteOffset = in_byteOffset;
HXDLIN( 188)						_this2->byteLength = newByteLength;
HXDLIN( 188)						_this2->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this2->bytesPerElement) )));
HXDLIN( 188)						this1 = _this2;
            					}
            					else {
...
HXDLIN( 188)		audioBuffer->data = this1;
HXLINE( 190)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_audio_load_file(::hx::DynamicPtr(path),::hx::DynamicPtr(audioBuffer))) );
            	}
...
HXLINE( 224)		 ::lime::media::AudioBuffer buffer = null();
HXLINE( 226)		{
HXLINE( 226)			int _g = 0;
HXDLIN( 226)			while((_g < paths->length)){
HXLINE( 226)				::String path = paths->__get(_g);
HXDLIN( 226)				_g = (_g + 1);
HXLINE( 228)				buffer = ::lime::media::AudioBuffer_obj::fromFile(path);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,fromFiles,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromVorbisFile( ::lime::media::vorbis::VorbisFile vorbisFile){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_238_fromVorbisFile)
HXLINE( 239)		if (::hx::IsNull( vorbisFile )) {
HXLINE( 239)			return null();
            		}
HXLINE( 241)		 ::lime::media::vorbis::VorbisInfo info = vorbisFile->info(null());
HXLINE( 243)		 ::lime::media::AudioBuffer audioBuffer =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 244)		audioBuffer->channels = info->channels;
HXLINE( 245)		audioBuffer->sampleRate = info->rate;
HXLINE( 246)		audioBuffer->bitsPerSample = 16;
HXLINE( 247)		audioBuffer->_hx___srcVorbisFile = vorbisFile;
HXLINE( 249)		return audioBuffer;
            	}
...
HXLINE( 298)			return null();
            	...
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_259_loadFromFile)
