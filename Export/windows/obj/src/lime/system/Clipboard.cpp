...
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_35___update,"lime.system.Clipboard","__update",0x48c84c67,"lime.system.Clipboard.__update","lime/system/Clipboard.hx",35,0x9490b5ee)
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_65_get_text,"lime.system.Clipboard","get_text",0xe647e374,"lime.system.Clipboard.get_text","lime/system/Clipboard.hx",65,0x9490b5ee)
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_96_set_text,"lime.system.Clipboard","set_text",0x94a53ce8,"lime.system.Clipboard.set_text","lime/system/Clipboard.hx",96,0x9490b5ee)
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_24_boot,"lime.system.Clipboard","boot",0x8554e870,"lime.system.Clipboard.boot","lime/system/Clipboard.hx",24,0x9490b5ee)
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_32_boot,"lime.system.Clipboard","boot",0x8554e870,"lime.system.Clipboard.boot","lime/system/Clipboard.hx",32,0x9490b5ee)
namespace lime{
...
void Clipboard_obj::_hx___update(){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_35___update)
HXLINE(  36)		::String cacheText = ::lime::_hx_system::Clipboard_obj::_text;
HXLINE(  37)		::lime::_hx_system::Clipboard_obj::_text = null();
HXLINE(  47)		::lime::_hx_system::Clipboard_obj::_text = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_clipboard_get_text()) );
HXLINE(  55)		::lime::_hx_system::Clipboard_obj::_hx___updated = true;
HXLINE(  57)		if ((::lime::_hx_system::Clipboard_obj::_text != cacheText)) {
HXLINE(  59)			::lime::_hx_system::Clipboard_obj::onUpdate->dispatch();
            		}
            	}
...
::String Clipboard_obj::get_text(){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_65_get_text)
HXLINE(  83)		if (!(::lime::_hx_system::Clipboard_obj::_hx___updated)) {
HXLINE(  88)			::lime::_hx_system::Clipboard_obj::_hx___update();
            		}
HXLINE(  92)		return ::lime::_hx_system::Clipboard_obj::_text;
            	}
...
::String Clipboard_obj::set_text(::String value){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_96_set_text)
HXLINE(  97)		::String cacheText = ::lime::_hx_system::Clipboard_obj::_text;
HXLINE(  98)		::lime::_hx_system::Clipboard_obj::_text = value;
HXLINE( 101)		::lime::_internal::backend::native::NativeCFFI_obj::lime_clipboard_set_text(value);
HXLINE( 112)		if ((::lime::_hx_system::Clipboard_obj::_text != cacheText)) {
HXLINE( 114)			::lime::_hx_system::Clipboard_obj::onUpdate->dispatch();
            		}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_21630ac4203d4998_24_boot)
HXDLIN(  24)		onUpdate =  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX );
            	}
{
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_32_boot)
HXDLIN(  32)		_hx___updated = false;
            	}
}
