...
HXLINE(  82)				::sys::thread::_Thread::HaxeThread_obj::create(this->_hx___doWork_dyn(),false);
            			}
...
HXLINE( 161)			if (::hx::IsPointerEq( message->type,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::WORK_dyn() )) {
HXLINE( 163)				this->runWork(message->state);
            			}
            			else {
HXLINE( 165)				if (::hx::IsPointerEq( message->type,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::EXIT_dyn() )) {
...
void ThreadPool_obj::_hx___update(::cpp::Int64 deltaTime){
...
HXLINE( 194)							this->currentThreads--;
HXLINE( 195)							 ::sys::thread::Deque _hx_tmp2 = this->_hx___workIncoming;
HXDLIN( 195)							_hx_tmp2->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::EXIT_dyn(),null()));
            						}
HXLINE( 198)						if (::hx::IsPointerEq( message->type,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::COMPLETE_dyn() )) {
HXLINE( 200)							this->onComplete->dispatch(message->state);
            						}
            						else {
HXLINE( 204)							this->onError->dispatch(message->state);
            						}
            					}
            					break;
            					case (int)3: {
...
HXLINE( 210)				message = this->_hx___workResult->pop(false).StaticCast<  ::lime::_hx_system::_ThreadPool::ThreadPoolMessage >();
            			}
            		}
            		else {
HXLINE( 217)			bool _hx_tmp3;
HXDLIN( 217)			bool _hx_tmp4;
HXDLIN( 217)			if ((this->currentThreads == 0)) {
HXLINE( 217)				_hx_tmp4 = (this->minThreads <= 0);
            			}
            			else {
HXLINE( 217)				_hx_tmp4 = false;
            			}
HXDLIN( 217)			if (_hx_tmp4) {
HXLINE( 217)				_hx_tmp3 = ::hx::IsNotNull( ::lime::app::Application_obj::current );
            			}
            			else {
HXLINE( 217)				_hx_tmp3 = false;
            			}
HXDLIN( 217)			if (_hx_tmp3) {
HXLINE( 219)				::lime::app::Application_obj::current->onUpdate->remove(this->_hx___update_dyn());
            			}
            		}
            	}
