...
HX_DEFINE_STACK_FRAME(_hx_pos_bb5354c74457ff34_241_new,"lime.system._ThreadPool.ThreadPoolMessage","new",0x973bef04,"lime.system._ThreadPool.ThreadPoolMessage.new","lime/system/ThreadPool.hx",241,0x8993fbb2)
namespace lime{
...
void ThreadPoolMessage_obj::__construct( ::lime::_hx_system::_ThreadPool::ThreadPoolMessageType type, ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_bb5354c74457ff34_241_new)
HXLINE( 242)		this->type = type;
HXLINE( 243)		this->state = state;
            	}
