...
HX_DEFINE_STACK_FRAME(_hx_pos_1a94701d58bd3d3e_636_new,"lime._internal.backend.native.ApplicationEventInfo","new",0xb35cdd3c,"lime._internal.backend.native.ApplicationEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",636,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_1a94701d58bd3d3e_643_clone,"lime._internal.backend.native.ApplicationEventInfo","clone",0x996e0f39,"lime._internal.backend.native.ApplicationEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",643,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void ApplicationEventInfo_obj::__construct( ::Dynamic type,::hx::Null< int >  __o_deltaTime){
            	...
            	HX_STACKFRAME(&_hx_pos_1a94701d58bd3d3e_636_new)
HXLINE( 637)		this->type = ( (int)(type) );
HXLINE( 638)		this->deltaTime = deltaTime;
            	}
...
bool ApplicationEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::ApplicationEventInfo ApplicationEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_1a94701d58bd3d3e_643_clone)
HXDLIN( 643)		return  ::lime::_internal::backend::native::ApplicationEventInfo_obj::__alloc( HX_CTX ,this->type,this->deltaTime);
            	}
