...
HXDLIN( 364)						int elementSize = _this1->bytesPerElement;
HXDLIN( 364)						if ((view->type == _this1->type)) {
HXLINE( 364)							int srcLength1 = srcData->length;
HXDLIN( 364)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 364)							_this1->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 364)							_this1->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 364)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 364)						_this1->byteLength = (_this1->bytesPerElement * srcLength);
HXDLIN( 364)						_this1->byteOffset = 0;
HXDLIN( 364)						_this1->length = srcLength;
...
HXDLIN( 364)							if ((::hx::Mod(in_byteOffset,_this2->bytesPerElement) != 0)) {
HXLINE( 364)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 364)							int bufferByteLength = buffer->length;
HXDLIN( 364)							int elementSize1 = _this2->bytesPerElement;
...
HXDLIN( 364)								if ((::hx::Mod(bufferByteLength,_this2->bytesPerElement) != 0)) {
HXLINE( 364)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 364)								newByteLength = (( (int)(len) ) * _this2->bytesPerElement);
HXDLIN( 364)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 364)								if ((newRange > bufferByteLength)) {
HXLINE( 364)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 364)							_this2->buffer = buffer;
HXDLIN( 364)							_this2->byteOffset = in_byteOffset;
HXDLIN( 364)							_this2->byteLength = newByteLength;
HXDLIN( 364)							_this2->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this2->bytesPerElement) )));
...
HXDLIN( 394)			::cpp::VirtualArray array1 = null();
...
HXLINE( 394)				if (::hx::IsNotNull( array1 )) {
HXLINE( 394)					 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 394)					_this3->byteOffset = 0;
HXDLIN( 394)					_this3->length = array1->get_length();
HXDLIN( 394)					_this3->byteLength = (_this3->length * _this3->bytesPerElement);
HXDLIN( 394)					_this3->buffer = ::haxe::io::Bytes_obj::alloc(_this3->byteLength);
HXDLIN( 394)					_this3->copyFromArray(array1,null());
HXDLIN( 394)					this2 = _this3;
            				}
            				else {
...
HXDLIN( 394)						int elementSize2 = _this4->bytesPerElement;
HXDLIN( 394)						if ((view1->type == _this4->type)) {
HXLINE( 394)							int srcLength3 = srcData1->length;
HXDLIN( 394)							int cloneLength1 = (srcLength3 - srcByteOffset1);
HXDLIN( 394)							_this4->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength1);
HXDLIN( 394)							_this4->buffer->blit(0,srcData1,srcByteOffset1,cloneLength1);
            						}
            						else {
HXLINE( 394)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 394)						_this4->byteLength = (_this4->bytesPerElement * srcLength2);
HXDLIN( 394)						_this4->byteOffset = 0;
HXDLIN( 394)						_this4->length = srcLength2;
...
HXDLIN( 394)							if ((::hx::Mod(in_byteOffset1,_this5->bytesPerElement) != 0)) {
HXLINE( 394)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 394)							int bufferByteLength1 = buffer2->length;
HXDLIN( 394)							int elementSize3 = _this5->bytesPerElement;
...
HXDLIN( 394)								if ((::hx::Mod(bufferByteLength1,_this5->bytesPerElement) != 0)) {
HXLINE( 394)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 394)								newByteLength1 = (( (int)(len1) ) * _this5->bytesPerElement);
HXDLIN( 394)								int newRange1 = (in_byteOffset1 + newByteLength1);
HXDLIN( 394)								if ((newRange1 > bufferByteLength1)) {
HXLINE( 394)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 394)							_this5->buffer = buffer2;
HXDLIN( 394)							_this5->byteOffset = in_byteOffset1;
HXDLIN( 394)							_this5->byteLength = newByteLength1;
HXDLIN( 394)							_this5->length = ::Std_obj::_hx_int((( (Float)(newByteLength1) ) / ( (Float)(_this5->bytesPerElement) )));
