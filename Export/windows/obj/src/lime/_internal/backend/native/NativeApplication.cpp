...
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_331_handleMouseEvent,"lime._internal.backend.native.NativeApplication","handleMouseEvent",0xca833524,"lime._internal.backend.native.NativeApplication.handleMouseEvent","lime/_internal/backend/native/NativeApplication.hx",331,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_364_handleRenderEvent,"lime._internal.backend.native.NativeApplication","handleRenderEvent",0x1dcebc95,"lime._internal.backend.native.NativeApplication.handleRenderEvent","lime/_internal/backend/native/NativeApplication.hx",364,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_416_handleSensorEvent,"lime._internal.backend.native.NativeApplication","handleSensorEvent",0x98787b31,"lime._internal.backend.native.NativeApplication.handleSensorEvent","lime/_internal/backend/native/NativeApplication.hx",416,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_426_handleTextEvent,"lime._internal.backend.native.NativeApplication","handleTextEvent",0xd6b1219e,"lime._internal.backend.native.NativeApplication.handleTextEvent","lime/_internal/backend/native/NativeApplication.hx",426,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_447_handleTouchEvent,"lime._internal.backend.native.NativeApplication","handleTouchEvent",0xa647254a,"lime._internal.backend.native.NativeApplication.handleTouchEvent","lime/_internal/backend/native/NativeApplication.hx",447,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_508_handleWindowEvent,"lime._internal.backend.native.NativeApplication","handleWindowEvent",0x42f025bb,"lime._internal.backend.native.NativeApplication.handleWindowEvent","lime/_internal/backend/native/NativeApplication.hx",508,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_580_updateTimer,"lime._internal.backend.native.NativeApplication","updateTimer",0xd6c37ab5,"lime._internal.backend.native.NativeApplication.updateTimer","lime/_internal/backend/native/NativeApplication.hx",580,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
HXLINE( 175)			this->parent->onUpdate->dispatch(( (::cpp::Int64)(this->applicationEventInfo->deltaTime) ));
            		}
            	}
...
HXLINE( 265)					 ::lime::app::_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Float_Void window1 = window->onKeyDownPrecise;
HXDLIN( 265)					window1->dispatch(keyCode,modifier,::lime::_hx_system::System_obj::getTimerPrecise());
            				}
            				break;
            				case (int)1: {
HXLINE( 267)					window->onKeyUp->dispatch(keyCode,modifier);
HXLINE( 268)					 ::lime::app::_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Float_Void window2 = window->onKeyUpPrecise;
HXDLIN( 268)					window2->dispatch(keyCode,modifier,::lime::_hx_system::System_obj::getTimerPrecise());
            				}
            				break;
            			}
HXLINE( 272)			if ((keyCode == 13)) {
HXLINE( 274)				if ((type == 0)) {
HXLINE( 276)					bool _hx_tmp;
HXDLIN( 276)					bool _hx_tmp1;
HXDLIN( 276)					if (this->toggleFullscreen) {
HXLINE( 276)						_hx_tmp1 = ::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier);
            					}
            					else {
...
HXDLIN( 276)						if (!(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier))) {
HXLINE( 276)							_hx_tmp2 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_shiftKey(modifier));
            						}
            						else {
HXLINE( 276)							_hx_tmp2 = false;
            						}
HXDLIN( 276)						if (_hx_tmp2) {
HXLINE( 276)							_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier));
            						}
            						else {
...
HXLINE( 278)						this->toggleFullscreen = false;
HXLINE( 280)						if (!(window->onKeyDown->canceled)) {
HXLINE( 282)							window->set_fullscreen(!(window->_hx___fullscreen));
            						}
            					}
            				}
            				else {
HXLINE( 288)					this->toggleFullscreen = true;
            				}
            			}
            		}
            	}
...
void NativeApplication_obj::handleMouseEvent(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_331_handleMouseEvent)
HXLINE( 332)		 ::lime::ui::Window window = ( ( ::lime::ui::Window)(this->parent->_hx___windowByID->get(this->mouseEventInfo->windowID)) );
HXLINE( 334)		if (::hx::IsNotNull( window )) {
HXLINE( 336)			switch((int)(this->mouseEventInfo->type)){
            				case (int)0: {
HXLINE( 339)					window->clickCount = this->mouseEventInfo->clickCount;
HXLINE( 340)					window->onMouseDown->dispatch(this->mouseEventInfo->x,this->mouseEventInfo->y,this->mouseEventInfo->button);
HXLINE( 341)					window->clickCount = 0;
            				}
            				break;
            				case (int)1: {
HXLINE( 344)					window->clickCount = this->mouseEventInfo->clickCount;
HXLINE( 345)					window->onMouseUp->dispatch(this->mouseEventInfo->x,this->mouseEventInfo->y,this->mouseEventInfo->button);
HXLINE( 346)					window->clickCount = 0;
            				}
            				break;
            				case (int)2: {
HXLINE( 349)					window->onMouseMove->dispatch(this->mouseEventInfo->x,this->mouseEventInfo->y);
HXLINE( 350)					window->onMouseMoveRelative->dispatch(this->mouseEventInfo->movementX,this->mouseEventInfo->movementY);
            				}
            				break;
            				case (int)3: {
HXLINE( 353)					window->onMouseWheel->dispatch(this->mouseEventInfo->x,this->mouseEventInfo->y,::lime::ui::MouseWheelMode_obj::UNKNOWN_dyn());
            				}
            				break;
            				default:{
            				}
...
void NativeApplication_obj::handleRenderEvent(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_364_handleRenderEvent)
HXDLIN( 364)		int _g = 0;
HXDLIN( 364)		::Array< ::Dynamic> _g1 = this->parent->_hx___windows;
HXDLIN( 364)		while((_g < _g1->length)){
HXDLIN( 364)			 ::lime::ui::Window window = _g1->__get(_g).StaticCast<  ::lime::ui::Window >();
HXDLIN( 364)			_g = (_g + 1);
HXLINE( 366)			if (::hx::IsNull( window )) {
HXLINE( 366)				continue;
            			}
HXLINE( 370)			switch((int)(this->renderEventInfo->type)){
            				case (int)0: {
HXLINE( 373)					if (::hx::IsNotNull( window->context )) {
HXLINE( 375)						window->_hx___backend->render();
HXLINE( 376)						window->onRender->dispatch(window->context);
HXLINE( 378)						if (!(window->onRender->canceled)) {
HXLINE( 380)							window->_hx___backend->contextFlip();
            						}
            					}
            				}
            				break;
...
HXDLIN( 385)					if (window->_hx___backend->useHardware) {
HXLINE( 385)						_hx_tmp = ::hx::IsNotNull( window->context );
            					}
            					else {
HXLINE( 385)						_hx_tmp = false;
            					}
HXDLIN( 385)					if (_hx_tmp) {
HXLINE( 387)						::String _hx_switch_0 = window->context->type;
            						if (  (_hx_switch_0==HX_("opengl",6f,64,94,21)) ||  (_hx_switch_0==HX_("opengles",9d,f6,c9,fa)) ||  (_hx_switch_0==HX_("webgl",b9,4b,bc,c7)) ){
HXLINE( 391)							 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = window->context->gl;
HXLINE( 392)							gl->_hx___contextLost();
HXLINE( 393)							if (::hx::IsInstanceEq( ::lime::graphics::opengl::GL_obj::context,gl )) {
HXLINE( 393)								::lime::graphics::opengl::GL_obj::context = null();
            							}
HXLINE( 389)							goto _hx_goto_14;
            						}
            						/* default */{
            						}
            						_hx_goto_14:;
HXLINE( 399)						window->context = null();
HXLINE( 400)						window->onRenderContextLost->dispatch();
            					}
            				}
            				break;
            				case (int)2: {
HXLINE( 404)					if (window->_hx___backend->useHardware) {
HXLINE( 409)						window->onRenderContextRestored->dispatch(window->context);
            					}
            				}
            				break;
            			}
...
void NativeApplication_obj::handleSensorEvent(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_416_handleSensorEvent)
HXLINE( 417)		 ::lime::_hx_system::Sensor sensor = ( ( ::lime::_hx_system::Sensor)(::lime::_hx_system::Sensor_obj::sensorByID->get(this->sensorEventInfo->id)) );
HXLINE( 419)		if (::hx::IsNotNull( sensor )) {
HXLINE( 421)			sensor->onUpdate->dispatch(this->sensorEventInfo->x,this->sensorEventInfo->y,this->sensorEventInfo->z);
            		}
            	}
...
void NativeApplication_obj::handleTextEvent(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_426_handleTextEvent)
HXLINE( 427)		 ::lime::ui::Window window = ( ( ::lime::ui::Window)(this->parent->_hx___windowByID->get(this->textEventInfo->windowID)) );
HXLINE( 429)		if (::hx::IsNotNull( window )) {
HXLINE( 431)			switch((int)(this->textEventInfo->type)){
            				case (int)0: {
HXLINE( 434)					window->onTextInput->dispatch(this->textEventInfo->text);
            				}
            				break;
            				case (int)1: {
...
void NativeApplication_obj::handleTouchEvent(){
            	HX_GC_STACKFRAME(&_hx_pos_8a85bd2a97260674_447_handleTouchEvent)
HXDLIN( 447)		switch((int)(this->touchEventInfo->type)){
            			case (int)0: {
HXLINE( 450)				 ::lime::ui::Touch touch = this->unusedTouchesPool->pop().StaticCast<  ::lime::ui::Touch >();
HXLINE( 452)				if (::hx::IsNull( touch )) {
HXLINE( 454)					touch =  ::lime::ui::Touch_obj::__alloc( HX_CTX ,this->touchEventInfo->x,this->touchEventInfo->y,this->touchEventInfo->id,this->touchEventInfo->dx,this->touchEventInfo->dy,this->touchEventInfo->pressure,this->touchEventInfo->device);
            				}
            				else {
HXLINE( 459)					touch->x = this->touchEventInfo->x;
HXLINE( 460)					touch->y = this->touchEventInfo->y;
HXLINE( 461)					touch->id = this->touchEventInfo->id;
HXLINE( 462)					touch->dx = this->touchEventInfo->dx;
HXLINE( 463)					touch->dy = this->touchEventInfo->dy;
HXLINE( 464)					touch->pressure = this->touchEventInfo->pressure;
HXLINE( 465)					touch->device = this->touchEventInfo->device;
            				}
HXLINE( 468)				this->currentTouches->set(touch->id,touch);
HXLINE( 470)				::lime::ui::Touch_obj::onStart->dispatch(touch);
            			}
            			break;
            			case (int)1: {
HXLINE( 473)				 ::lime::ui::Touch touch1 = ( ( ::lime::ui::Touch)(this->currentTouches->get(this->touchEventInfo->id)) );
HXLINE( 475)				if (::hx::IsNotNull( touch1 )) {
HXLINE( 477)					touch1->x = this->touchEventInfo->x;
HXLINE( 478)					touch1->y = this->touchEventInfo->y;
HXLINE( 479)					touch1->dx = this->touchEventInfo->dx;
HXLINE( 480)					touch1->dy = this->touchEventInfo->dy;
HXLINE( 481)					touch1->pressure = this->touchEventInfo->pressure;
HXLINE( 483)					::lime::ui::Touch_obj::onEnd->dispatch(touch1);
HXLINE( 485)					this->currentTouches->remove(this->touchEventInfo->id);
HXLINE( 486)					this->unusedTouchesPool->add(touch1);
            				}
            			}
            			break;
            			case (int)2: {
HXLINE( 490)				 ::lime::ui::Touch touch2 = ( ( ::lime::ui::Touch)(this->currentTouches->get(this->touchEventInfo->id)) );
HXLINE( 492)				if (::hx::IsNotNull( touch2 )) {
...
void NativeApplication_obj::handleWindowEvent(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_508_handleWindowEvent)
HXLINE( 509)		 ::lime::ui::Window window = ( ( ::lime::ui::Window)(this->parent->_hx___windowByID->get(this->windowEventInfo->windowID)) );
HXLINE( 511)		if (::hx::IsNotNull( window )) {
HXLINE( 513)			switch((int)(this->windowEventInfo->type)){
            				case (int)0: {
HXLINE( 516)					this->advanceTimer();
HXLINE( 517)					window->onActivate->dispatch();
HXLINE( 518)					::lime::media::AudioManager_obj::resume();
            				}
            				break;
            				case (int)1: {
HXLINE( 521)					window->close();
            				}
            				break;
            				case (int)2: {
HXLINE( 524)					window->onDeactivate->dispatch();
HXLINE( 525)					::lime::media::AudioManager_obj::suspend();
HXLINE( 526)					this->pauseTimer = ::lime::_hx_system::System_obj::getTimer();
            				}
            				break;
            				case (int)3: {
HXLINE( 529)					window->onEnter->dispatch();
            				}
            				break;
            				case (int)4: {
HXLINE( 532)					window->onExpose->dispatch();
            				}
            				break;
            				case (int)5: {
HXLINE( 535)					window->onFocusIn->dispatch();
            				}
            				break;
            				case (int)6: {
HXLINE( 538)					window->onFocusOut->dispatch();
            				}
            				break;
            				case (int)7: {
HXLINE( 541)					window->onLeave->dispatch();
            				}
            				break;
            				case (int)8: {
HXLINE( 544)					window->_hx___maximized = true;
HXLINE( 545)					window->_hx___fullscreen = false;
HXLINE( 546)					window->_hx___minimized = false;
HXLINE( 547)					window->onMaximize->dispatch();
            				}
            				break;
            				case (int)9: {
HXLINE( 550)					window->_hx___minimized = true;
HXLINE( 551)					window->_hx___maximized = false;
HXLINE( 552)					window->_hx___fullscreen = false;
...
HXLINE( 568)					window->onRestore->dispatch();
            				...
            				break;
            				case (int)13: {
HXLINE( 571)					window->onShow->dispatch();
            				}
            				break;
            				case (int)14: {
HXLINE( 574)					window->onHide->dispatch();
            				}
            				break;
            			}
            		}
...
void NativeApplication_obj::updateTimer(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_580_updateTimer)
HXLINE( 582)		if ((::haxe::Timer_obj::sRunningTimers->length > 0)) {
...
HXLINE( 608)				::Array< ::Dynamic> _g2 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 608)				{
HXLINE( 608)					int _g3 = 0;
HXDLIN( 608)					::Array< ::Dynamic> _g4 = ::haxe::Timer_obj::sRunningTimers;
HXDLIN( 608)					while((_g3 < _g4->length)){
HXLINE( 608)						 ::haxe::Timer v = _g4->__get(_g3).StaticCast<  ::haxe::Timer >();
HXDLIN( 608)						_g3 = (_g3 + 1);
HXDLIN( 608)						if (::hx::IsNotNull( v )) {
HXLINE( 608)							_g2->push(v);
            						}
            					}
            				}
HXDLIN( 608)				::haxe::Timer_obj::sRunningTimers = _g2;
            			}
            		}
HXLINE( 617)		::sys::thread::_Thread::Thread_Impl__obj::get_events(::sys::thread::_Thread::HaxeThread_obj::current())->progress();
            	}
