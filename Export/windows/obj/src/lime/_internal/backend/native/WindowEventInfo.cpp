...
HX_DEFINE_STACK_FRAME(_hx_pos_d8a53269ce4a50a3_953_new,"lime._internal.backend.native.WindowEventInfo","new",0x4cd621b8,"lime._internal.backend.native.WindowEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",953,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_d8a53269ce4a50a3_964_clone,"lime._internal.backend.native.WindowEventInfo","clone",0x771e6ab5,"lime._internal.backend.native.WindowEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",964,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void WindowEventInfo_obj::__construct( ::Dynamic type,::hx::Null< int >  __o_windowID,::hx::Null< int >  __o_width,::hx::Null< int >  __o_height,::hx::Null< int >  __o_x,::hx::Null< int >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_d8a53269ce4a50a3_953_new)
HXLINE( 954)		this->type = ( (int)(type) );
HXLINE( 955)		this->windowID = windowID;
HXLINE( 956)		this->width = width;
HXLINE( 957)		this->height = height;
HXLINE( 958)		this->x = x;
HXLINE( 959)		this->y = y;
            	}
...
bool WindowEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::WindowEventInfo WindowEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_d8a53269ce4a50a3_964_clone)
HXDLIN( 964)		return  ::lime::_internal::backend::native::WindowEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->width,this->height,this->x,this->y);
            	}
