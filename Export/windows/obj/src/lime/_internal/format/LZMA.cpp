...
HX_LOCAL_STACK_FRAME(_hx_pos_335285a16ed3a766_17_compress,"lime._internal.format.LZMA","compress",0x0f40ff02,"lime._internal.format.LZMA.compress","lime/_internal/format/LZMA.hx",17,0x658d9751)
HX_LOCAL_STACK_FRAME(_hx_pos_335285a16ed3a766_40_decompress,"lime._internal.format.LZMA","decompress",0x92fad783,"lime._internal.format.LZMA.decompress","lime/_internal/format/LZMA.hx",40,0x658d9751)
namespace lime{
namespace _internal{
namespace format{
...
bool LZMA_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes LZMA_obj::compress( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_335285a16ed3a766_17_compress)
HXDLIN(  17)		::cpp::Function<  ::hx::Object *  ( ::hx::Object *, ::hx::Object *) > _hx_tmp = ::lime::_internal::backend::native::NativeCFFI_obj::lime_lzma_compress;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LZMA_obj,compress,return )
 ...
 ::haxe::io::Bytes LZMA_obj::decompress( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_335285a16ed3a766_40_decompress)
HXDLIN(  40)		::cpp::Function<  ::hx::Object *  ( ::hx::Object *, ::hx::Object *) > _hx_tmp = ::lime::_internal::backend::native::NativeCFFI_obj::lime_lzma_decompress;
HXDLIN(  40)		return ( ( ::Dynamic)(_hx_tmp(::hx::DynamicPtr(bytes),::hx::DynamicPtr(::haxe::io::Bytes_obj::alloc(0)))) );
            	}
