...
HX_LOCAL_STACK_FRAME(_hx_pos_eb00e02a6b98bd42_17_compress,"lime._internal.format.Deflate","compress",0xbe9cd2d1,"lime._internal.format.Deflate.compress","lime/_internal/format/Deflate.hx",17,0xb5ff7ebe)
HX_LOCAL_STACK_FRAME(_hx_pos_eb00e02a6b98bd42_47_decompress,"lime._internal.format.Deflate","decompress",0xafce7d12,"lime._internal.format.Deflate.decompress","lime/_internal/format/Deflate.hx",47,0xb5ff7ebe)
namespace lime{
namespace _internal{
namespace format{
...
bool Deflate_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes Deflate_obj::compress( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_eb00e02a6b98bd42_17_compress)
HXDLIN(  17)		::cpp::Function<  ::hx::Object *  ( ::hx::Object *, ::hx::Object *) > _hx_tmp = ::lime::_internal::backend::native::NativeCFFI_obj::lime_deflate_compress;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Deflate_obj,compress,return )
 ...
 ::haxe::io::Bytes Deflate_obj::decompress( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_eb00e02a6b98bd42_47_decompress)
HXDLIN(  47)		::cpp::Function<  ::hx::Object *  ( ::hx::Object *, ::hx::Object *) > _hx_tmp = ::lime::_internal::backend::native::NativeCFFI_obj::lime_deflate_decompress;
HXDLIN(  47)		return ( ( ::Dynamic)(_hx_tmp(::hx::DynamicPtr(bytes),::hx::DynamicPtr(::haxe::io::Bytes_obj::alloc(0)))) );
            	}
