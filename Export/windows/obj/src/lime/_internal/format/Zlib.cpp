...
HX_LOCAL_STACK_FRAME(_hx_pos_1e53264516846038_17_compress,"lime._internal.format.Zlib","compress",0x612ac019,"lime._internal.format.Zlib.compress","lime/_internal/format/Zlib.hx",17,0x132edd28)
HX_LOCAL_STACK_FRAME(_hx_pos_1e53264516846038_47_decompress,"lime._internal.format.Zlib","decompress",0x83a84c5a,"lime._internal.format.Zlib.decompress","lime/_internal/format/Zlib.hx",47,0x132edd28)
namespace lime{
namespace _internal{
namespace format{
...
bool Zlib_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes Zlib_obj::compress( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_1e53264516846038_17_compress)
HXDLIN(  17)		::cpp::Function<  ::hx::Object *  ( ::hx::Object *, ::hx::Object *) > _hx_tmp = ::lime::_internal::backend::native::NativeCFFI_obj::lime_zlib_compress;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Zlib_obj,compress,return )
 ...
 ::haxe::io::Bytes Zlib_obj::decompress( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_1e53264516846038_47_decompress)
HXDLIN(  47)		::cpp::Function<  ::hx::Object *  ( ::hx::Object *, ::hx::Object *) > _hx_tmp = ::lime::_internal::backend::native::NativeCFFI_obj::lime_zlib_decompress;
