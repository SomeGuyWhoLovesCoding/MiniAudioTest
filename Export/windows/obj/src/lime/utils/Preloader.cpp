...
HX_LOCAL_STACK_FRAME(_hx_pos_e07f6fac014e5fdd_98_addLibrary,"lime.utils.Preloader","addLibrary",0x72ea3408,"lime.utils.Preloader.addLibrary","lime/utils/Preloader.hx",98,0xe721f000)
HX_LOCAL_STACK_FRAME(_hx_pos_e07f6fac014e5fdd_103_addLibraryName,"lime.utils.Preloader","addLibraryName",0xd5217673,"lime.utils.Preloader.addLibraryName","lime/utils/Preloader.hx",103,0xe721f000)
HX_LOCAL_STACK_FRAME(_hx_pos_e07f6fac014e5fdd_110_load,"lime.utils.Preloader","load",0xa37544d4,"lime.utils.Preloader.load","lime/utils/Preloader.hx",110,0xe721f000)
HX_LOCAL_STACK_FRAME(_hx_pos_e07f6fac014e5fdd_125_load,"lime.utils.Preloader","load",0xa37544d4,"lime.utils.Preloader.load","lime/utils/Preloader.hx",125,0xe721f000)
HX_LOCAL_STACK_FRAME(_hx_pos_e07f6fac014e5fdd_143_load,"lime.utils.Preloader","load",0xa37544d4,"lime.utils.Preloader.load","lime/utils/Preloader.hx",143,0xe721f000)
HX_LOCAL_STACK_FRAME(_hx_pos_e07f6fac014e5fdd_157_load,"lime.utils.Preloader","load",0xa37544d4,"lime.utils.Preloader.load","lime/utils/Preloader.hx",157,0xe721f000)
HX_LOCAL_STACK_FRAME(_hx_pos_e07f6fac014e5fdd_174_loadedAssetLibrary,"lime.utils.Preloader","loadedAssetLibrary",0x526bc9be,"lime.utils.Preloader.loadedAssetLibrary","lime/utils/Preloader.hx",174,0xe721f000)
HX_LOCAL_STACK_FRAME(_hx_pos_e07f6fac014e5fdd_195_start,"lime.utils.Preloader","start",0x6e4321f4,"lime.utils.Preloader.start","lime/utils/Preloader.hx",195,0xe721f000)
HX_LOCAL_STACK_FRAME(_hx_pos_e07f6fac014e5fdd_203_update,"lime.utils.Preloader","update",0x8d85b837,"lime.utils.Preloader.update","lime/utils/Preloader.hx",203,0xe721f000)
HX_LOCAL_STACK_FRAME(_hx_pos_e07f6fac014e5fdd_206_updateProgress,"lime.utils.Preloader","updateProgress",0x4fb7fb04,"lime.utils.Preloader.updateProgress","lime/utils/Preloader.hx",206,0xe721f000)
...
HX_LOCAL_STACK_FRAME(_hx_pos_e07f6fac014e5fdd_252_updateProgress,"lime.utils.Preloader","updateProgress",0x4fb7fb04,"lime.utils.Preloader.updateProgress","lime/utils/Preloader.hx",252,0xe721f000)
HX_LOCAL_STACK_FRAME(_hx_pos_e07f6fac014e5fdd_273_updateProgress,"lime.utils.Preloader","updateProgress",0x4fb7fb04,"lime.utils.Preloader.updateProgress","lime/utils/Preloader.hx",273,0xe721f000)
namespace lime{
namespace utils{
...
HXLINE(  56)		this->bytesLoaded = 0;
HXLINE(  57)		this->bytesTotal = 0;
HXLINE(  59)		this->libraries = ::Array_obj< ::Dynamic>::__new();
HXLINE(  60)		this->libraryNames = ::Array_obj< ::String >::__new();
HXLINE(  62)		this->onProgress->add(this->update_dyn(),null(),null());
            	}
...
void Preloader_obj::addLibrary( ::lime::utils::AssetLibrary library){
            	HX_STACKFRAME(&_hx_pos_e07f6fac014e5fdd_98_addLibrary)
HXDLIN(  98)		this->libraries->push(library);
            	}
...
void Preloader_obj::addLibraryName(::String name){
            	HX_STACKFRAME(&_hx_pos_e07f6fac014e5fdd_103_addLibraryName)
HXDLIN( 103)		if ((this->libraryNames->indexOf(name,null()) == -1)) {
HXLINE( 105)			this->libraryNames->push(name);
            		}
            	}
...
void Preloader_obj::load(){
            	HX_STACKFRAME(&_hx_pos_e07f6fac014e5fdd_110_load)
HXDLIN( 110)		 ::lime::utils::Preloader _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 111)		{
HXLINE( 111)			int _g = 0;
HXDLIN( 111)			::Array< ::Dynamic> _g1 = this->libraries;
HXDLIN( 111)			while((_g < _g1->length)){
HXLINE( 111)				 ::lime::utils::AssetLibrary library = _g1->__get(_g).StaticCast<  ::lime::utils::AssetLibrary >();
HXDLIN( 111)				_g = (_g + 1);
HXLINE( 113)				 ::lime::utils::Preloader _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 113)				_hx_tmp->bytesTotal = (_hx_tmp->bytesTotal + library->bytesTotal);
            			}
            		}
HXLINE( 116)		this->loadedLibraries = -1;
HXLINE( 117)		this->preloadStarted = false;
HXLINE( 119)		{
HXLINE( 119)			int _g2 = 0;
HXDLIN( 119)			::Array< ::Dynamic> _g3 = this->libraries;
HXDLIN( 119)			while((_g2 < _g3->length)){
            				...
            				void _hx_run(int loaded,int total){
            					HX_STACKFRAME(&_hx_pos_e07f6fac014e5fdd_125_load)
HXLINE( 126)					if (!(_gthis->bytesLoadedCache->exists(library1))) {
HXLINE( 128)						 ::lime::utils::Preloader _gthis1 = _gthis;
HXDLIN( 128)						_gthis1->bytesLoaded = (_gthis1->bytesLoaded + loaded);
            					}
            					else {
HXLINE( 132)						 ::lime::utils::Preloader _gthis2 = _gthis;
HXDLIN( 132)						int _gthis3 = _gthis2->bytesLoaded;
HXDLIN( 132)						_gthis2->bytesLoaded = (_gthis3 + (loaded - _gthis->bytesLoadedCache->get_int(library1)));
            					}
HXLINE( 135)					_gthis->bytesLoadedCache->set(library1,loaded);
HXLINE( 137)					if (!(_gthis->simulateProgress)) {
HXLINE( 139)						_gthis->onProgress->dispatch(_gthis->bytesLoaded,_gthis->bytesTotal);
            					}
            				}
            				...
            				void _hx_run( ::lime::utils::AssetLibrary _){
            					HX_STACKFRAME(&_hx_pos_e07f6fac014e5fdd_143_load)
HXLINE( 144)					if (!(_gthis->bytesLoadedCache->exists(library1))) {
HXLINE( 146)						 ::lime::utils::Preloader _gthis1 = _gthis;
HXDLIN( 146)						_gthis1->bytesLoaded = (_gthis1->bytesLoaded + library1->bytesTotal);
            					}
            					else {
HXLINE( 150)						 ::lime::utils::Preloader _gthis2 = _gthis;
HXDLIN( 150)						int _gthis3 = _gthis2->bytesLoaded;
HXDLIN( 150)						int _hx_tmp = ::Std_obj::_hx_int(( (Float)(library1->bytesTotal) ));
HXDLIN( 150)						_gthis2->bytesLoaded = (_gthis3 + (_hx_tmp - _gthis->bytesLoadedCache->get_int(library1)));
            					}
HXLINE( 153)					_gthis->loadedAssetLibrary(null());
            				}
            				HX_END_LOCAL_FUNC1((void))

            				HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_2) HXARGC(1)
            				void _hx_run( ::Dynamic e){
            					HX_STACKFRAME(&_hx_pos_e07f6fac014e5fdd_157_load)
HXLINE( 157)					::lime::utils::Log_obj::error(e,::hx::SourceInfo(HX_("lime/utils/Preloader.hx",00,f0,21,e7),157,HX_("lime.utils.Preloader",80,b4,12,ca),HX_("load",26,9a,b7,47)));
            				}
            				HX_END_LOCAL_FUNC1((void))

HXLINE( 119)				 ::lime::utils::AssetLibrary library1 = _g3->__get(_g2).StaticCast<  ::lime::utils::AssetLibrary >();
HXDLIN( 119)				_g2 = (_g2 + 1);
HXLINE( 121)				::lime::utils::Log_obj::verbose(HX_("Preloading asset library",44,27,6d,96),::hx::SourceInfo(HX_("lime/utils/Preloader.hx",00,f0,21,e7),121,HX_("lime.utils.Preloader",80,b4,12,ca),HX_("load",26,9a,b7,47)));
HXLINE( 123)				library1->load()->onProgress( ::Dynamic(new _hx_Closure_0(_gthis,library1)))->onComplete( ::Dynamic(new _hx_Closure_1(_gthis,library1)))->onError( ::Dynamic(new _hx_Closure_2()));
            			}
            		}
HXLINE( 163)		{
HXLINE( 163)			int _g4 = 0;
HXDLIN( 163)			::Array< ::String > _g5 = this->libraryNames;
HXDLIN( 163)			while((_g4 < _g5->length)){
HXLINE( 163)				::String name = _g5->__get(_g4);
HXDLIN( 163)				_g4 = (_g4 + 1);
HXLINE( 165)				 ::lime::utils::Preloader _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 165)				_hx_tmp1->bytesTotal = (_hx_tmp1->bytesTotal + 200);
            			}
            		}
HXLINE( 168)		this->loadedLibraries++;
HXLINE( 169)		this->preloadStarted = true;
HXLINE( 170)		this->updateProgress();
            	}
...
void Preloader_obj::loadedAssetLibrary(::String name){
            	HX_STACKFRAME(&_hx_pos_e07f6fac014e5fdd_174_loadedAssetLibrary)
HXLINE( 175)		this->loadedLibraries++;
HXLINE( 177)		int current = this->loadedLibraries;
HXLINE( 178)		if (!(this->preloadStarted)) {
HXLINE( 178)			current = (current + 1);
            		}
HXLINE( 180)		int totalLibraries = (this->libraries->length + this->libraryNames->length);
HXLINE( 182)		if (::hx::IsNotNull( name )) {
HXLINE( 184)			::lime::utils::Log_obj::verbose(((((((HX_("Loaded asset library: ",36,ba,cc,98) + name) + HX_(" [",3b,1c,00,00)) + current) + HX_("/",2f,00,00,00)) + totalLibraries) + HX_("]",5d,00,00,00)),::hx::SourceInfo(HX_("lime/utils/Preloader.hx",00,f0,21,e7),184,HX_("lime.utils.Preloader",80,b4,12,ca),HX_("loadedAssetLibrary",90,0a,d2,6a)));
            		}
            		else {
HXLINE( 188)			::lime::utils::Log_obj::verbose(((((HX_("Loaded asset library [",cb,a3,cc,98) + current) + HX_("/",2f,00,00,00)) + totalLibraries) + HX_("]",5d,00,00,00)),::hx::SourceInfo(HX_("lime/utils/Preloader.hx",00,f0,21,e7),188,HX_("lime.utils.Preloader",80,b4,12,ca),HX_("loadedAssetLibrary",90,0a,d2,6a)));
            		}
HXLINE( 191)		this->updateProgress();
            	}
...
void Preloader_obj::start(){
            	HX_STACKFRAME(&_hx_pos_e07f6fac014e5fdd_195_start)
HXLINE( 196)		bool _hx_tmp;
HXDLIN( 196)		bool _hx_tmp1;
HXDLIN( 196)		if (!(this->complete)) {
HXLINE( 196)			_hx_tmp1 = this->simulateProgress;
            		}
            		else {
HXLINE( 196)			_hx_tmp1 = true;
            		}
HXDLIN( 196)		if (!(_hx_tmp1)) {
HXLINE( 196)			_hx_tmp = !(this->preloadComplete);
            		}
            		else {
...
HXLINE( 198)		this->complete = true;
HXLINE( 200)		this->onComplete->dispatch();
            	}
...
void Preloader_obj::update(int loaded,int total){
            	HX_STACKFRAME(&_hx_pos_e07f6fac014e5fdd_203_update)
            	}
...
void Preloader_obj::updateProgress(){
            	HX_STACKFRAME(&_hx_pos_e07f6fac014e5fdd_206_updateProgress)
HXDLIN( 206)		 ::lime::utils::Preloader _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 207)		if (!(this->simulateProgress)) {
HXLINE( 209)			this->onProgress->dispatch(this->bytesLoaded,this->bytesTotal);
            		}
HXLINE( 213)		bool _hx_tmp;
HXDLIN( 213)		if ((this->loadedLibraries == this->libraries->length)) {
HXLINE( 213)			_hx_tmp = !(this->initLibraryNames);
            		}
            		else {
HXLINE( 213)			_hx_tmp = false;
            		}
HXDLIN( 213)		if (_hx_tmp) {
HXLINE( 215)			this->initLibraryNames = true;
HXLINE( 217)			{
HXLINE( 217)				int _g = 0;
HXDLIN( 217)				::Array< ::String > _g1 = this->libraryNames;
...
HXLINE( 224)						if ((total > 0)) {
HXLINE( 226)							if (!(_gthis->bytesTotalCache->exists(name))) {
HXLINE( 228)								_gthis->bytesTotalCache->set(name,total);
HXLINE( 229)								 ::lime::utils::Preloader _gthis1 = _gthis;
HXDLIN( 229)								_gthis1->bytesTotal = (_gthis1->bytesTotal + (total - 200));
            							}
HXLINE( 232)							if ((loaded > total)) {
HXLINE( 232)								loaded = total;
            							}
HXLINE( 234)							if (!(_gthis->bytesLoadedCache2->exists(name))) {
HXLINE( 236)								 ::lime::utils::Preloader _gthis2 = _gthis;
HXDLIN( 236)								_gthis2->bytesLoaded = (_gthis2->bytesLoaded + loaded);
            							}
            							else {
HXLINE( 240)								 ::lime::utils::Preloader _gthis3 = _gthis;
HXDLIN( 240)								int _gthis4 = _gthis3->bytesLoaded;
HXDLIN( 240)								_gthis3->bytesLoaded = (_gthis4 + (loaded - _gthis->bytesLoadedCache2->get_int(name)));
            							}
HXLINE( 243)							_gthis->bytesLoadedCache2->set(name,loaded);
HXLINE( 245)							if (!(_gthis->simulateProgress)) {
HXLINE( 247)								_gthis->onProgress->dispatch(_gthis->bytesLoaded,_gthis->bytesTotal);
            							}
            						}
            					}
            					HX_END_LOCAL_FUNC2((void))
            					...
            					void _hx_run( ::lime::utils::AssetLibrary library){
            						HX_STACKFRAME(&_hx_pos_e07f6fac014e5fdd_252_updateProgress)
HXLINE( 253)						int total = 200;
HXLINE( 255)						if (_gthis->bytesTotalCache->exists(name)) {
HXLINE( 257)							total = _gthis->bytesTotalCache->get_int(name);
            						}
HXLINE( 260)						if (!(_gthis->bytesLoadedCache2->exists(name))) {
HXLINE( 262)							 ::lime::utils::Preloader _gthis1 = _gthis;
HXDLIN( 262)							_gthis1->bytesLoaded = (_gthis1->bytesLoaded + total);
            						}
            						else {
HXLINE( 266)							 ::lime::utils::Preloader _gthis2 = _gthis;
HXDLIN( 266)							int _gthis3 = _gthis2->bytesLoaded;
HXDLIN( 266)							_gthis2->bytesLoaded = (_gthis3 + (total - _gthis->bytesLoadedCache2->get_int(name)));
            						}
HXLINE( 269)						_gthis->loadedAssetLibrary(name);
            					}
            					HX_END_LOCAL_FUNC1((void))

            					HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_2) HXARGC(1)
            					void _hx_run( ::Dynamic e){
            						HX_STACKFRAME(&_hx_pos_e07f6fac014e5fdd_273_updateProgress)
HXLINE( 273)						::lime::utils::Log_obj::error(e,::hx::SourceInfo(HX_("lime/utils/Preloader.hx",00,f0,21,e7),273,HX_("lime.utils.Preloader",80,b4,12,ca),HX_("updateProgress",d6,ea,54,bb)));
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE( 217)					::String name = _g1->__get(_g);
HXDLIN( 217)					_g = (_g + 1);
HXLINE( 219)					::lime::utils::Log_obj::verbose((HX_("Preloading asset library: ",ea,b2,78,e9) + name),::hx::SourceInfo(HX_("lime/utils/Preloader.hx",00,f0,21,e7),219,HX_("lime.utils.Preloader",80,b4,12,ca),HX_("updateProgress",d6,ea,54,bb)));
HXLINE( 221)					::lime::utils::Assets_obj::loadLibrary(name)->onProgress( ::Dynamic(new _hx_Closure_0(name,_gthis)))->onComplete( ::Dynamic(new _hx_Closure_1(name,_gthis)))->onError( ::Dynamic(new _hx_Closure_2()));
            				}
            			}
            		}
HXLINE( 279)		bool _hx_tmp1;
HXDLIN( 279)		if (!(this->simulateProgress)) {
HXLINE( 279)			_hx_tmp1 = (this->loadedLibraries == (this->libraries->length + this->libraryNames->length));
            		}
            		else {
HXLINE( 279)			_hx_tmp1 = false;
            		}
HXDLIN( 279)		if (_hx_tmp1) {
HXLINE( 282)			if (!(this->preloadComplete)) {
HXLINE( 284)				this->preloadComplete = true;
HXLINE( 286)				::lime::utils::Log_obj::verbose(HX_("Preload complete",10,f4,03,24),::hx::SourceInfo(HX_("lime/utils/Preloader.hx",00,f0,21,e7),286,HX_("lime.utils.Preloader",80,b4,12,ca),HX_("updateProgress",d6,ea,54,bb)));
            			}
HXLINE( 289)			this->start();
            		}
            	}
